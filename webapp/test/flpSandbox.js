		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sybcooltravelmanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sybcooltravelmanagement-display": {
								"semanticObject": "sybcooltravelmanagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sybcool.travelmanagement",
									"url": sap.ui.require.toUrl("sybcool/travelmanagement")
								}
							}
						}
					}
